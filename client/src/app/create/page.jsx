...
const Create = () => {
	...
	const handleSubmit = async (event) => {
		...
		try {
			...
			await contract.createCampaign(title, description, imageUrl, target, deadline, { gasLimit: 1000000 })
	...
	return (
		<main className="w-full bg-neutral-800 rounded-lg min-h-[calc(100vh-96px)]">
			...
			<form className="p-4 flex flex-col gap-4 min-h-[calc(100vh-192px)]" onSubmit={handleSubmit}>
